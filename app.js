...
function login() {
    ...
    while (!loggedUser) {
        ...
        let passWord = parseInt(readlineSync.question("Enter your pin:   ", { hideEchoBack: true }));
    ...
    while (loggedUser) {
        ...
        let mainIndex = readlineSync.keyInSelect(mainChoices, "Select any choice: ");
        switch (mainChoices[mainIndex]) {
            case "Deposit funds":
                let amountToDeposit = parseInt(readlineSync.question("Enter amount to deposit: "));
